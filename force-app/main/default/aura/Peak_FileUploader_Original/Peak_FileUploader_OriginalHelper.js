...
({
    ...
    goBack: function(component, event, helper) {
        ...
        if(!$A.util.isEmpty(studentId)) {
            url = '/oblenroll/s/enrollment?studentId=' + encodeURIComponent(studentId) + '&caretakerId=' + encodeURIComponent(caretakerId) + '&processId=' + encodeURIComponent(processId) + '&programEnrollmentId=' + encodeURIComponent(programEnrollmentId) + '&studentGrade=' + encodeURIComponent(studentGrade);
        } else {
            url = '/dashboard';
        }
        ...
        if(studentId == null || studentId === ""){
            ...
            helper.doCallout(component, 'c.grabURLredirect', params).then(function (response) {
                ...
                if (response.success) { 
                    ...
                    url = '/oblenroll/s/enrollment?studentId=' + encodeURIComponent(studentId) + '&studentName=' + encodeURIComponent(studentName) + '&processId=' + encodeURIComponent(processId) + '&programEnrollmentId=' + encodeURIComponent(programEnrollmentId) + '&studentGrade=' + encodeURIComponent(studentGrade);
                    var event = $A.get("e.force:navigateToURL");
                    event.setParams({
                        "url": url
                    });
